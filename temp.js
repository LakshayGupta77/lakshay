...
function startbutton() {
  document.getElementById("start-button").style.transform = "scale(0.8)";
  setTimeout(function () {
    document.getElementById("start-button").style.transform = "scale(1)";
...
function burstLoveEmojisFullscreen() {
  if (numEmojis > 0) {
    ...
    setTimeout(burstLoveEmojisFullscreen, 20);
  }
  if (numEmojis === 0) {
    setTimeout(function () {
